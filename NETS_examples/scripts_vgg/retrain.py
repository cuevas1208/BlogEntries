...
python scripts/retrain.py --image_dir ./../../dataSets/flower_photos/
"""
...
def get_bottleneck_path(image_lists, label_name, index, bottleneck_dir,
  ...
  """
  return li.get_image_path(image_lists, label_name, index, bottleneck_dir,
...
def create_bottleneck_file(bottleneck_path, image_lists, label_name, index,
  ...
  image_path = li.get_image_path(image_lists, label_name, index,
                              image_dir, category)
...
def get_random_distorted_bottlenecks(
  ...
  for unused_i in range(how_many):
    ...
    label_name = list(image_lists.keys())[label_index]
    image_index = random.randrange(MAX_NUM_IMAGES_PER_CLASS + 1)
    image_path = li.get_image_path(image_lists, label_name, image_index, image_dir,
                                category)
    if not gfile.Exists(image_path):
      tf.logging.fatal('File does not exist %s', image_path)
