...
def main(args):
    ...
    train_filenames, train_labels = lds.list_images(args.train_dir)
    val_filenames, val_labels = lds.list_images(args.val_dir)
    ...
    with graph.as_default():
        ...
        images, labels, train_init_op, val_init_op = pds.get_input_pipeline(train_filenames, train_labels,
